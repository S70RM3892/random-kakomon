...
export const UNIVERSITIES = [
  ...
  { id: "kobe", name: "神戸大学", shortName: "神大", defaultWeight: 2, sortOrder: 9 },
  { id: "hitotsubashi", name: "一橋大学", shortName: "一橋", defaultWeight: 1, sortOrder: 10 },
  { id: "waseda", name: "早稲田大学", shortName: "早大", defaultWeight: 1, sortOrder: 11 },
  { id: "keio", name: "慶應義塾大学", shortName: "慶大", defaultWeight: 1, sortOrder: 12 },
] as const;
...
export const FORMAT_PRESETS: FormatPreset[] = [
  ...
  },
  {
    ...
    questionCount: 5,
    totalPoints: 150,
    sourceUrl: "https://jyuke-labo.com/daigakujyukentaisaku/kobedaigaku/suugaku/",
    accessUrl: "https://www.kobe-u.ac.jp/ja/admissions/undergraduate/examinations/",
    hasSolution: false,
    note: "理系は120分・5題で全問記述。各大問30点が明示されているので満点150点",
  },
  {
    ...
    durationMin: 120,
    questionCount: 5,
    sourceUrl: "https://jyuke-labo.com/daigakujyukentaisaku/hitotsubashidaigaku/kamokubetsu/",
    accessUrl: "https://juken.hit-u.ac.jp/admission/info/ito.html",
    hasSolution: false,
    note: "前期120分・5題。配点は学部ごとに違う（社会130〜SDS330）ので満点は入れない。整数と確率が頻出で、理系の演習にも使える",
  },
  {
    universityId: "waseda",
    faculty: "基幹理工学部",
