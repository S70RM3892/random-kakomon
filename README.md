...
現在の実装範囲は **MVP（F1〜F8）**。F9〜F11（結果共有・履歴分析・復習キュー）は2版目。
...
2. SQL Editor で [`supabase/migrations/0001_init.sql`](./supabase/migrations/0001_init.sql) を実行する
